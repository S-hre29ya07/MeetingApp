...
import com.example.Interviewapplication.bottomSheetFragment.CreateandEditBottomSheetFragment;
...
public class ListAdapter extends RecyclerView.Adapter<ListAdapter.TaskViewHolder> {
    ...
    CreateandEditBottomSheetFragment.setRefreshListener setRefreshListener;

    public ListAdapter(MainActivity context, List<Task> taskList, CreateandEditBottomSheetFragment.setRefreshListener setRefreshListener) {
        ...
        popupMenu.setOnMenuItemClickListener(item -> {
            switch (item.getItemId()) {
                ...
                case R.id.menuUpdate:
                    CreateandEditBottomSheetFragment createTaskBottomSheetFragment = new CreateandEditBottomSheetFragment();
